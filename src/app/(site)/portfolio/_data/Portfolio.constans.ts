...
export const projects: Project[] = [
	{
		slug: "fsb-viewer",
		title: "레거시 학습 콘텐츠 뷰어 유지보수 및 고도화 (FSB Viewer)",
		subtitle: "jQuery 기반 뷰어를 TypeScript 및 Vite 환경으로 전환",
		period: "2023.07 ~ 현재", // 이 기간은 임의로 작성되었으므로 수정이 필요합니다.
		company: "윤선생",
		tags: ["JavaScript", "jQuery", "TypeScript", "Vite"],
		highlights: [
			"Vite 도입으로 개발 환경 구축 및 빌드 시간 단축",
			"레거시 jQuery 코드를 TypeScript 기반으로 점진적 전환",
			"질문 유형(Q-Type)에 따른 동적 컴포넌트 렌더링 구조 설계",
		],
		description:
		"오래된 jQuery 기반의 학습 콘텐츠 뷰ㄴ어(FSB Viewer)를 유지보수하고 현대화하는 프로젝트입니다. 다양한 질문 유형(Q-Type)을 파싱하고 동적으로 렌더링하는 핵심 로직을 담당했습니다. 점진적으로 TypeScript와 Vite를 도입하여 레거시 코드를 리팩터링하고, 개발 생산성과 빌드 성능을 개선했습니다.",
	},
	{
		slug: "yoons-time",
