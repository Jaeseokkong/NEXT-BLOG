        ...
        >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-2">
                ...
                <Link
                    ...
                    className="group block rounded-xl border border-zinc-100 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-4 hover:border-indigo-200 dark:hover:border-indigo-800 transition-colors"
                >
                    ...
                    <MoreButton className="mt-3">자세히 보기</MoreButton>
                </Link>
                ))}
            </div>
        </PreviewSection>
