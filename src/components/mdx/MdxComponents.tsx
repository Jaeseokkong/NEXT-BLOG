...
export const MdxComponents: MDXComponents = {
  h1: (props) => <h1 className="text-3xl font-bold mt-8 mb-4 text-indigo-600 dark:text-indigo-400" {...props} />,
  ...
  blockquote: (props) => (
    <blockquote className="border-l-4 border-indigo-500 pl-4 italic text-zinc-600 dark:text-zinc-300" {...props} />
  ),
};
