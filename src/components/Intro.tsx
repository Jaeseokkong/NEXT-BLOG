...
const Intro = () => {
  return (
    <section className="mb-10 rounded-xl bg-[#f7df1e]/30 dark:bg-[#f7df1e]/10 p-6 md:p-8 shadow-md">
      ...
      <p className="text-zinc-800 dark:text-zinc-200 leading-relaxed text-base md:text-lg">
        안녕하세요! <span className="font-semibold">HJS</span>의 개발 공부 기록 블로그입니다. <br />
